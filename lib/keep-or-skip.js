 ...
 * @param {Boolean} debug An optional boolean parameter to enable a warning log
 * which notifies that the predicate parameter doesn't return a boolean value.
 * In such a case the middleware/middlewares contained in the middlewares
